    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                User user = new User(userName, userEmail, userPassword, userPhone, "default.png", userAddress, Constants.NORMAL_USER.toString());
                ...
                httpSession.setAttribute("message", "Signup successful !! "+userId);
